...
{	
	...
	function Error ($code) {
		...
		$errors = array(
						...
						'5012' => 'A valid description is requred.',
						'5013' => 'This trasaction requires a billing address.  If no customer ID is supplied, first_name, last_name, address_1, city, state, postal_code, and country are required.',
