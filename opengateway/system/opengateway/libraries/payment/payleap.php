...
class payleap
{
	...
	function Settings()
	{
		...
		$settings['description'] = 'A payment gateway for the new web, PayLeap is one of the most affordable, developer-friendly payment gateways out there.';
		$settings['is_preferred'] = 1;
		$settings['setup_fee'] = '$29.00';
		$settings['monthly_fee'] = '$29.00';
