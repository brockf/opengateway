...
<ul>
	<li>*/5 * 	* 	* 	* wget -q <?=rtrim($cp_link, '/');?>/cron/sendnotifications/<?=$cron_key;?> >/dev/null 2>&1</li>
	<li>5	5 	* 	* 	* wget -q <?=rtrim($cp_link, '/');?>/cron/subscriptionmaintenance/<?=$cron_key;?> >/dev/null 2>&1</li>
</ul>
