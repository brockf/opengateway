...
CREATE TABLE `authnet_log` (
  ...
  `response_code` varchar(11) default NULL,
  `response_subcode` varchar(11) default NULL,
  `response_reason_code` int(11) default NULL,
  `response_reason_text` varchar(255) default NULL,
  `authorization_code` int(6) default NULL,
  ...
  `ship_to_address` varchar(60) default NULL,
  `ship_to_city` varchar(40) default NULL,
  `ship_to_state` varchar(40) default NULL,
  `ship_to_zip_code` varchar(20) default NULL,
  `ship_to_country` varchar(60) default NULL,
  `tax` decimal(10,2) default NULL,
  `duty` decimal(10,2) default NULL,
  `freight` decimal(10,2) default NULL,
  `tax_exempt` tinyint(4) default NULL,
  `purchase_order_number` varchar(25) default NULL,
...
-- 
-- Table structure for table `exact_log`
-- 

CREATE TABLE `exact_log` (
  `response_id` int(11) NOT NULL auto_increment,
  `order_id` int(11) NOT NULL,
  `ExactID` varchar(255) NOT NULL,
  `Password` varchar(255) NOT NULL,
  ...
  `CardHoldersName` varchar(100) NOT NULL,
  `VerificationStr1` varchar(255) NOT NULL,
  `CVD_Presence_Ind` int(11) NOT NULL,
  `Secure_AuthRequired` int(11) NOT NULL,
  `Secure_AuthResult` int(11) NOT NULL,
  `Ecommerce_Flag` int(11) NOT NULL,
  `CAVV_Algorithm` varchar(255) NOT NULL,
  `Customer_Ref` int(11) NOT NULL,
  `LogonMessage` varchar(255) NOT NULL,
  `Error_Number` int(11) NOT NULL,
  `Error_Description` varchar(255) NOT NULL,
  `Transaction_Error` int(11) NOT NULL,
  `Transaction_Approved` varchar(255) NOT NULL,
  `EXact_Resp_Code` int(11) NOT NULL,
  `EXact_Message` varchar(255) NOT NULL,
  `MerchantName` varchar(255) NOT NULL,
  `MerchantAddress` varchar(255) NOT NULL,
  `MerchantCity` varchar(255) NOT NULL,
  `MerchantProvince` varchar(255) NOT NULL,
  `MerchantCountry` varchar(255) NOT NULL,
  `MerchantPostal` varchar(255) NOT NULL,
